...
# python train_man_bert.py --dataset amazon-lang --model dan --max_epoch 14 --model_save_file ./save/train_bert_shared_private_man --topic_domain all --domains de en fr --no_wgan_trick --sum_pooling --shared_hidden_size 768 --shared_private_man
